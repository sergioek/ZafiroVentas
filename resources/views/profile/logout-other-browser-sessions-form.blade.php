<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Ingrese su contraseña para confirmar que desea cerrar la sesión de sus otras sesiones del navegador en todos sus dispositivos. Ingrese su contraseña para confirmar que desea cerrar la sesión de sus otras sesiones del navegador en todos sus dispositivos.
                ') }}
