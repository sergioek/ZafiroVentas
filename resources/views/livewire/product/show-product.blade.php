<div>
    ...
    <div class="container-row">
        ...
        <div class="form-check form-check-inline">
            ...
            <input class="form-check-input" type="radio" wire:model.debounce.300ms="filter" value="all" checked>
            <label class="form-check-label" for="inlineCheckbox1">TODOS</label>
            
        </div>
            @forelse ($category as $category)
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" wire:model.debounce.300ms="filter" value="{{$category->id}}">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @else
                       <input type="number" class="form-control" name="amount" id="" max="{{$product->stock}}" min="1" value="1" wire:model.debounce.300ms="amount">
                       <td>
